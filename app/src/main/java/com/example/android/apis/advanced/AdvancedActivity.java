 ...
 * <p>
 * Features:
 * 1. Search file according to current activity;
 * 2. Show file content with {@link CodeView} with can highlight the code;
 * Get more information about the library in {@link https://github.com/Thereisnospon/CodeView};
 * </p>
 */
    ...
    public static class LoadCodeTask extends AsyncTask<File, Void, String> {
        ...
        protected void onPostExecute(String ret) {
            ...
            if (!TextUtils.isEmpty(ret) && mActivityWeakReference.get() != null) {
                mActivityWeakReference.get().mCodeView.showCode(ret);
            } else {
